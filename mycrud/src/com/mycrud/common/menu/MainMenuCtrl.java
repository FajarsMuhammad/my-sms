 ...
 */
package com.mycrud.common.menu;
...
import com.mycrud.common.menu.dropdown.ZkossDropDownMenuFactory;
import com.mycrud.common.menu.tree.ZkossTreeMenuFactory;
import com.mycrud.webui.util.WindowBaseCtrl;
...
public class MainMenuCtrl extends WindowBaseCtrl implements Serializable {
	...
	private void createMenu() throws InterruptedException {
		...
		//comment by fajar
		showPage("/WEB-INF/zul/welcome.zul", "Home");
	}
